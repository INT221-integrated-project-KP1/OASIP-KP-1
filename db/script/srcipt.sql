...
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('OASIP ADMIN','oasip.admin@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$Ik5MzmkvUsg$TCN8I3QDHtSZQFZfJh89FQ','admin','2022-08-01 00:00:00+07:00','2022-08-01 00:00:00+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('Olarn Rojanapornpun','olarn.roj@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$Y2LYZpIfTDU$+N3K0A9Amttuw5z8DBPrFA','lecturer','2022-08-08 15:00:00+07:00','2022-08-08 15:00:00+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('Pichet Limvachiranan','pichet.limv@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$RhkzNUqXI4E$nUdBM+Iq9/fNi+WBO0QTBA','lecturer','2022-08-08 15:00:01+07:00','2022-08-08 15:00:01+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('Umaporn Supasitthimethee','umaporn.sup@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$Pd1/Gwb63vQ$P1zIEquLah83oInw0p0Mhg','lecturer','2022-08-08 15:00:02+07:00','2022-08-08 15:00:02+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('Siam Yamsaengsung','siam.yam@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$UojFJoeYayI$QdDRrqNi1rTWsxfwUe1dIQ','lecturer','2022-08-08 15:00:03+07:00','2022-08-08 15:00:03+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('Sunisa Sathapornvajana','sunisa.sat@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$KSUiMwdl87E$Bl902XlLa+qiJYMV2YfkFQ','lecturer','2022-08-08 15:00:04+07:00','2022-08-08 15:00:04+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('Somchai Jaidee','somchai.jai@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$tZIzdwQwcvU$WjIA0f/a//My5x/FD+iaeQ','student','2022-08-08 16:00:00+07:00','2022-08-08 16:00:00+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('Komkrid Rakdee','komkrid.rak@mail.kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$UV8xH47JBAQ$UKGFnoiqfCyrCsAB/ywqtw','student','2022-08-08 16:00:00+07:00','2022-08-08 16:00:00+07:00');
insert into myuser (name,email,password,role,createdOn,updatedOn) values ('สมเกียรติ ขยันเรียน','somkiat.kay@kmutt.ac.th','$argon2id$v=19$m=4096,t=3,p=1$rk+nWYL+Njo$JMhjxkTYUVGY7XbCTjidjw','student','2022-08-16 09:00:00+07:00','2022-08-16 09:00:00+07:00');
